...
const SCRIPT_LINE = 'apply from: "../../node_modules/@op-engineering/react-native-prisma/react-native-prisma.gradle"';
const withPrismaAndroid = (config) => {
    const cfg = (0, config_plugins_1.withAppBuildGradle)(config, (config) => {
        if (config.modResults.language === 'groovy') {
            ...
            throw new Error('Cannot configure prisma because app/Build.gradle because it is not groovy');
        }
        return config;
    });
    return cfg;
