...
module.exports = {
  ...
  apps: {
    // 'ios.debug': {
    //   type: 'ios.app',
    //   binaryPath: 'ios/build/Build/Products/Debug-iphonesimulator/Prisma.app',
    //   build: 'xcodebuild -workspace ios/PrismaExample.xcworkspace -scheme Debug -configuration Debug -sdk iphonesimulator -derivedDataPath ios/build'
    // },
    'ios.release': {
      type: 'ios.app',
